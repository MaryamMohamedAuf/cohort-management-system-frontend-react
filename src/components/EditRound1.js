...
setCohortId(data.applicant.cohort_id);
        setFormData({
          ...
          company_website: data.round1.company_website || '',
          company_zip_code: data.round1.company_zip_code || '',
          year_company_founded: data.round1.year_company_founded || '',
          number_of_founding_team_members: data.round1.number_of_founding_team_members || '',
          current_product_stage: data.round1.current_product_stage || '',
          current_business_stage: data.round1.current_business_stage || '',
          company_formed: data.round1.company_formed || '',
          one_sentence_description: data.round1.one_sentence_description || '',
          company_team_location: data.round1.company_team_location || '',
          if_you_selected_other_please_specify: data.round1.if_you_selected_other_please_specify ||'',
          short_problem_description: data.round1.short_problem_description || '',
          detailed_description: data.round1.detailed_description || '',
          applied_to_accelerator: data.round1.applied_to_accelerator || '',
          If_Yes_please_indicate_ALL_the_PREVIOUS_places: data.round1.If_Yes_please_indicate_ALL_the_PREVIOUS_places ||'',
          previous_accelerator_places: data.round1.previous_accelerator_places || '',
          funding_received: data.round1?.funding_received ? data.round1.funding_received.split(',') : [],
          amount_funding_raised: data.round1.amount_funding_raised || '',
          revenue_generated: data.round1.revenue_generated || '',
          covid_impact: data.round1.covid_impact || '',
          reason_for_applying: data.round1.reason_for_applying || '',
          biggest_challenge: data.round1.biggest_challenge || '',
          how_did_you_hear_about_us: data.round1?.how_did_you_hear_about_us ? data.round1.how_did_you_hear_about_us.split(',') : [],
          race_ethnicity: data.round1?.race_ethnicity ? data.round1.race_ethnicity.split(',') : [],
          gender: data.round1?.gender ? data.round1.gender.split(',') : [],
          additional_demographics: data.round1.additional_demographics || '',
          team_identifiers: data.round1?.team_identifiers ? data.round1.team_identifiers.split(',') : [],
  ...
  const handleChange = (e) => {
    ...
    if (type === 'checkbox') {
      // Initialize formData[name] as an empty array if it's undefined
      let currentValue = formData[name] ? [...formData[name]] : [];
      ...
      // Update formData with the new value or empty array
...
e.g. The ACME Corp. provides you with a monthly subscription of the latest Rube Goldberg traps guaranteed to catch a roadrunner or your money back.</label>
  ...
  <div className="form-check">
    <input
      ...
      onChange={handleChange}
    />
    <label className="form-check-label">Grants</label>
  </div>
<div className="form-check">
    <input
      className="form-check-input"
