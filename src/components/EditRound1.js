...
setCohortId(data.applicant.cohort_id);
        setFormData({
          ...
          year_company_founded: data.year_company_founded || '',
          number_of_founding_team_members: data.number_of_founding_team_members || '',
          current_product_stage: data.current_product_stage || '',
          current_business_stage: data.current_business_stage || '',
          company_formed: data.company_formed || '',
          one_sentence_description: data.one_sentence_description || '',
          company_team_location: data.company_team_location || '',
          if_you_selected_other_please_specify: data.if_you_selected_other_please_specify ||'',
          short_problem_description: data.short_problem_description || '',
          detailed_description: data.detailed_description || '',
          applied_to_accelerator: data.applied_to_accelerator || '',
          If_Yes_please_indicate_ALL_the_PREVIOUS_places: data.If_Yes_please_indicate_ALL_the_PREVIOUS_places ||'',
          previous_accelerator_places: data.previous_accelerator_places || '',
          funding_received: data.funding_received ? data.funding_received.split(',') : [],
          amount_funding_raised: data.amount_funding_raised || '',
          revenue_generated: data.revenue_generated || '',
          covid_impact: data.covid_impact || '',
          reason_for_applying: data.reason_for_applying || '',
          biggest_challenge: data.biggest_challenge || '',
          how_did_you_hear_about_us: data.how_did_you_hear_about_us ? data.how_did_you_hear_about_us.split(',') : [],
          race_ethnicity: data.race_ethnicity ? data.race_ethnicity.split(',') : [],
          gender: data.gender ? data.gender.split(',') : [],
          additional_demographics: data.additional_demographics || '',
